...
public class RequestControllerTests {
    ...
    void setUp() {
        ...
        request = requestController.createRequest(user.getId(), requestDto);
    }
    ...
    void shouldCreateRequestTest() {
        ...
        RequestDto newCreatedRequest = requestController.createRequest(user.getId(), newRequestDto);
    ...
    void shouldGetUserRequestsTest() {
        Collection<RequestDtoOut> userRequests = requestController.getUserRequests(user.getId());
    ...
    void shouldGetAllRequestsTest() {
        Collection<RequestDto> allRequests = requestController.getRequests(user.getId(), 0, 10);
    ...
    void shouldGetRequestByIdTest() {
        RequestDtoOut retrievedRequest = requestController.getRequest(user.getId(), request.getId());
